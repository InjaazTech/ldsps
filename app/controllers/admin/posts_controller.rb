class Admin::PostsController < Admin::BaseController
    ...
    private
      ...
      def post_params
        params.require(:post).permit(:attachment_id, :post_type_id, :ar_title, :en_title, :tr_title, :ar_subtitle, :is_published, :en_subtitle, :tr_subtitle, :ar_content, :en_content, :tr_content, :ar_video_url, :en_video_url, :price, :speed_limit, :seo_limit, :order_position, :keywords_tasks_limit, :attachments_ids => [])
      end
  end